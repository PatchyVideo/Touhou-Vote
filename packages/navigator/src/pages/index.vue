...
const resultListRaw: [string, string, string, string][] = [
  [
    'v1',
    '一',
    'https://upload.touhou.vote/imgs/index/vote01@100px.png',
    '2012/7/23 ~ 7/30',
  ],
  [
    'v2',
    '二',
    'https://upload.touhou.vote/imgs/index/vote02@100px.png',
    '2013/10/1 ~ 10/7',
  ],
  [
    'v3',
    '三',
    'https://upload.touhou.vote/imgs/index/vote03@100px.png',
    '2014/8/22 ~ 8/28',
  ],
  [
    'v4',
    '四',
    'https://upload.touhou.vote/imgs/index/vote04@100px.png',
    '2015/10/1 ~ 10/15',
  ],
  [
    'v5',
    '五',
    'https://upload.touhou.vote/imgs/index/vote05@100px.png',
    '2016/10/1 ~ 10/15',
  ],
  [
    'v6',
    '六',
    'https://upload.touhou.vote/imgs/index/vote06@100px.png',
    '2017/10/1 ~ 10/15',
  ],
  [
    'v7',
    '七',
    'https://upload.touhou.vote/imgs/index/vote07@100px.png',
    '2018/09/30 ~ 10/14',
  ],
  [
    'v8',
    '八',
    'https://upload.touhou.vote/imgs/index/vote08@100px.png',
    '2019/09/30 ~ 10/14',
  ],
  [
    'v9',
    '⑨',
    'https://upload.touhou.vote/imgs/index/vote09@100px.png',
    '2020/12/18 ~ 12/31',
  ],
  [
    'v10',
    '⑩',
    'https://upload.touhou.vote/imgs/index/vote10@100px.png',
    '2022/06/17 ~ 07/03',
  ],
]
