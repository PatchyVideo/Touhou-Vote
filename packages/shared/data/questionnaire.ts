        ...
        [
          {
            ...
            options: [
              ...
              },
              {
                ...
                related: [],
                mutex: [],
                content: '2021年～2022年期间',
              },
              {
                id: 1108103,
                related: [],
                mutex: [],
                content: '2018～2020年期间',
              },
              {
                id: 1108104,
                related: [],
        ...
        [
          {
            ...
            options: [
              ...
              },
              {
                ...
                related: [],
                mutex: [],
                content: '了解，没在玩，但一直在关注',
              },
              {
                id: 1314104,
                related: [],
                mutex: [],
                content: '了解，但没在玩，也不感兴趣',
              },
              {
                id: 1314105,
                related: [],
            ...
            options: [
              {
                ...
                related: [23051],
                mutex: [],
                content: '玩过前作东方弹幕神乐，对新作很感兴趣',
              },
              {
                id: 2304102,
                related: [23051],
                mutex: [],
                content: '玩过前作东方弹幕神乐，现在不感兴趣了',
              },
              {
                id: 2304103,
                related: [23050],
          ...
          },
          {
            ...
            options: [
              ...
              },
              {
                ...
                related: [24030],
                mutex: [],
                content: '我已经有类似的其他语言官方正版书籍了',
              },
              {
                id: 2402103,
                related: [24030],
                mutex: [],
                content: '我已经有类似的盗版书籍了',
              },
              {
                id: 2402104,
                related: [24030],
        ...
        [
          {
            ...
            options: [
              ...
              },
              {
                ...
                related: [],
                mutex: [],
                content: '短视频平台（如抖音，快手等）',
              },
              {
                id: 2506103,
                related: [],
                mutex: [],
                content: '即时通信工具（如QQ、微信、Discord等）',
              },
              {
                id: 2506104,
                related: [],
                mutex: [],
                content: '主题社区（如百度贴吧，论坛等）',
              },
              {
                id: 2506105,
                related: [],
                mutex: [],
                content: '生活分享平台（如INS、小红书等）',
              },
              {
                id: 2506106,
                related: [],
                mutex: [],
                content: 'SNS平台（如QQ空间，微博，X（推特）等）',
              },
              {
                id: 2506107,
                related: [],
