  ...
  return {
    mainQuestionnaire: {
      requiredQuestionnaire: {
        id: 11,
        answers: [
          { id: 11011, options: [], input: '' },
          { id: 11021, options: [], input: '' },
          { id: 11031, options: [], input: '' },
          { id: 11041, options: [], input: '' },
          { id: 11051, options: [], input: '' },
          { id: 11061, options: [], input: '' },
          { id: 11070, options: [], input: '' },
          { id: 11081, options: [], input: '' },
          { id: 11091, options: [], input: '' },
          { id: 11101, options: [], input: '' },
          { id: 11111, options: [], input: '' },
        ],
      },
      optionalQuestionnaire1: {
        id: 12,
        answers: [
          { id: 12011, options: [], input: '' },
          { id: 12021, options: [], input: '' },
          { id: 12031, options: [], input: '' },
          { id: 12041, options: [], input: '' },
          { id: 12051, options: [], input: '' },
          { id: 12061, options: [], input: '' },
          { id: 12071, options: [], input: '' },
          { id: 12081, options: [], input: '' },
          { id: 12091, options: [], input: '' },
          { id: 12101, options: [], input: '' },
          { id: 12111, options: [], input: '' },
          { id: 12121, options: [], input: '' },
        ],
      },
      optionalQuestionnaire2: {
        id: 13,
        answers: [
          { id: 13011, options: [], input: '' },
          { id: 13021, options: [], input: '' },
          { id: 13031, options: [], input: '' },
          { id: 13041, options: [], input: '' },
          { id: 13050, options: [], input: '' },
          { id: 13060, options: [], input: '' },
          { id: 13070, options: [], input: '' },
          { id: 13081, options: [], input: '' },
          { id: 13090, options: [], input: '' },
          { id: 13100, options: [], input: '' },
          { id: 13110, options: [], input: '' },
          { id: 13121, options: [], input: '' },
          { id: 13131, options: [], input: '' },
          { id: 13141, options: [], input: '' },
        ],
      },
    },
    extraQuestionnaire: {
      exQuestionnaire1: {
        id: 21,
        answers: [
          { id: 21011, options: [], input: '' },
          { id: 21021, options: [], input: '' },
          { id: 21031, options: [], input: '' },
          { id: 21041, options: [], input: '' },
          { id: 21051, options: [], input: '' },
          { id: 21061, options: [], input: '' },
          { id: 21071, options: [], input: '' },
        ],
      },
      exQuestionnaire2: {
        id: 22,
        answers: [
          { id: 22011, options: [], input: '' },
          { id: 22020, options: [], input: '' },
          { id: 22031, options: [], input: '' },
          { id: 22041, options: [], input: '' },
          { id: 22050, options: [], input: '' },
          { id: 22061, options: [], input: '' },
          { id: 22070, options: [], input: '' },
          { id: 22081, options: [], input: '' },
        ],
      },
      exQuestionnaire3: {
        id: 23,
        answers: [
          { id: 23011, options: [], input: '' },
          { id: 23021, options: [], input: '' },
          { id: 23031, options: [], input: '' },
          { id: 23041, options: [], input: '' },
          { id: 23050, options: [], input: '' },
          { id: 23061, options: [], input: '' },
          { id: 23071, options: [], input: '' },
        ],
      },
      exQuestionnaire4: {
        id: 24,
        answers: [
          { id: 24011, options: [], input: '' },
          { id: 24020, options: [], input: '' },
          { id: 24030, options: [], input: '' },
          { id: 24040, options: [], input: '' },
          { id: 24051, options: [], input: '' },
          { id: 24061, options: [], input: '' },
          { id: 24070, options: [], input: '' },
          { id: 24081, options: [], input: '' },
          { id: 24090, options: [], input: '' },
          { id: 24101, options: [], input: '' },
          { id: 24110, options: [], input: '' },
          { id: 24121, options: [], input: '' },
          { id: 24130, options: [], input: '' },
          { id: 24141, options: [], input: '' },
          { id: 24150, options: [], input: '' },
          { id: 24161, options: [], input: '' },
        ],
      },
      exQuestionnaire5: {
        id: 25,
        answers: [
          { id: 25011, options: [], input: '' },
          { id: 25021, options: [], input: '' },
          { id: 25030, options: [], input: '' },
          { id: 25041, options: [], input: '' },
          { id: 25051, options: [], input: '' },
          { id: 25061, options: [], input: '' },
          { id: 25071, options: [], input: '' },
          { id: 25081, options: [], input: '' },
          { id: 25091, options: [], input: '' },
          { id: 25100, options: [], input: '' },
          { id: 25111, options: [], input: '' },
          { id: 25121, options: [], input: '' },
          { id: 25131, options: [], input: '' },
        ],
      },
    },
  }
