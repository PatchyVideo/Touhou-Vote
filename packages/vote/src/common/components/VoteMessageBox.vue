<template>
  <transition name="messageBox">
    <div
      v-if="open"
      class="baseBoxRoundedShadow fixed max-h-2/3 top-1/2 mx-auto left-0 right-0 -mt-70 p-2 border border-accent-color-300 w-19/20 max-w-70ch z-51 flex flex-col"
    >
