<template>
  <div class="min-h-[calc(100vh-44px)] md:min-h-0">
    ...
    <div class="w-full p-3 space-y-2">
      <div class="flex w-full p-0.5 shadow rounded bg-subaccent bg-opacity-80 backdrop-filter backdrop-blur-2">
