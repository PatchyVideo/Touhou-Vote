<template>
        ...
        >
          ...
          <div v-for="(item2, index) in resultMusicsForDisplay" :key="item2.rank" class="relative">
            <div
              ...
              :class="{ 'pb-40': lineExpanded[index] }"
            >
              <div
            ...
            >
              <div class="p-1 rounded border border-accent-600 divide-y divide-accent-300">
                ...
                <div class="py-1">
                  曲目详情：<router-link class="cursor-pointer" :to="'/musicSingleDetail?rank=' + item2.rank"
                    >点击这里</router-link
                  >
                </div>
              </div>
  ...
  <AdvancedSearch v-model:open="search" :musicSearchRange="true" />
</template>
...
const averageVotesPerItemMusic = ref(-1)
const medianVotesPerItemMusic = ref(-1)
