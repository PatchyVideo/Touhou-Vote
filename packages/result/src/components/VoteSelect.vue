<template>
  <div class="inline-block relative">
    <div
      ref="VoteSelectRoot"
      class="flex justify-between cursor-pointer p-1 md:px-3 rounded border border-accent-300"
      @click="listHidden = !listHidden"
    >
      <div class="truncate" :title="selected.name === '' ? selectedName : selected.name">
    ...
    <div
      ...
      class="absolute z-52 rounded bg-white shadow mt-1 w-full max-h-50 overflow-auto"
