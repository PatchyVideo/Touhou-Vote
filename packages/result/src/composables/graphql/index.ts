...
export function createApollo(): ApolloClient<NormalizedCacheObject> {
  ...
  //           for (let i = 0; i < incoming[tagName].length; ++i) merged[offset + i] = incoming[tagName][i]
  //         }
  //         return merged
  //       })(),
  //     }
